...
function adjustWordsPosition() {
    ...
    $("#words").css("top", $("#garden").position().top + $("#garden").height()/2 - 60); // Adjusted from -50 to -120
    $("#words").css("left", $("#garden").position().left + $("#garden").width()/2);
    $("#words").css("transform", "translate(-50%, -50%)"); // Add this line to center both horizontally and vertically
}
